<template>
    <div id="page-wrapper">
      <div class="header">
        ...
        <el-button type="primary" @click="dialogInspection=true">巡检功能</el-button>
    ...
    <!-- 巡检功能 -->
    <el-dialog title="添加巡检人员":visible.sync="dialogInspection">
        <el-form >
        <el-form-item label="巡检人员">
            <el-select v-model="form.stuffName" prop="activity_range" placeholder="请选择巡检人员">
            <el-option v-for="item in stuff"  :label="item.name" :value="item.name"></el-option>
            </el-select>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogInspection=false">取消</el-button>
        <el-button type="primary" @click="initWebSocket1">确定</el-button>
      </div>
    </el-dialog>
...
// import { websocketonopen,websocketonerror,websocketonmessage,websocketclose,websocketonopenApp,websocketonmessageApp } from '../js/alert';
...
// }
    ...
    informAPP(row)
    {
        this.websocketApp.send("baojing")
...
　　　},
    ...
    { 
        ...
        //console.log(this.form.stuffName)
         const wsuriApp = "ws://39.104.189.84:30270/api/v1/map/websocket?username=pf_3&usertype=consumer&sessionId="+this.form.stuffName;//ws地址 
         this.websocketApp = new WebSocket(wsuriApp);
         this.websocketApp.onopen = this.websocketonopenApp(this.form.stuffName);
...
　　　},
    ///////////App定位ws////////
    websocketonopenApp(e) {
        console.log("WebSocket连接成功-App-"+e);　　　　　　　
　　　},
